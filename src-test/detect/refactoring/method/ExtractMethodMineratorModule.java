...
public class ExtractMethodMineratorModule {
...
public static void main(String[] args) throws IOException {
        ...
        File historicProject = new File("E:\\Projetos_Clip\\Method_Metrics\\Historic_Methods\\CSV_HISTORIC_V2\\"
        		+ "RESULTS_EXTRACT_METHOD\\ClipOcr_ExtractHistoric.txt");
		...
		try {
			repo = gitService.openRepository("E:\\Projetos_Clip\\Projects\\clip-ocr");
